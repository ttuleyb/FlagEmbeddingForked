...
def main():
    ...
    # Setup logging
    logging.basicConfig(
        format="%(asctime)s - %(levelname)s - %(name)s - %(message)s",  # Correct the logging format
        datefmt="%m/%d/%Y %H:%M:%S",
    ...
    logger.info("Training/evaluation parameters: %s", training_args)  # Adjusted the logging calls
